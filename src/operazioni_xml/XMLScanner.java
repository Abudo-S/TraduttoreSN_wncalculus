...
//    //predicate: (\s*[(]*\s*([_a-zA-Z]+[_a-zA-Z0-9]*)\s*(<=|>=|<|>|=|!\s*=|\s+in\s+|\s*!\s*in\s+)\s*([_a-zA-Z]+[_a-zA-Z0-9]*)\s*[)]*\s*)
//    //Guard uses predicate:
//    /* 
//    (\s*[(]*\s*([_a-zA-Z]+[_a-zA-Z0-9]*)\s*(<=|>=|<|>|=|!\s*=|\s+in\s+|\s*!\s*in\s+)\s*([_a-zA-Z]+[_a-zA-Z0-9]*)\s*[)]*\s*)
//    (\s*(&amp;&amp;|[|]{2})(\s*[(]*\s*([_a-zA-Z]+[_a-zA-Z0-9]*)\s*(<=|>=|<|>|=|!\s*=|\s+in\s+|\s*!\s*in\s+)\s*([_a-zA-Z]+[_a-zA-Z0-9]*)\s*[)]*\s*))*
//    */ 
//    //tuple:
//    /*
